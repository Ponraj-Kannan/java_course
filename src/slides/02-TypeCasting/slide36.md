...
const contents = [
  ...
  { text: '<b>Note:</b> Encryption adds 3 to the ASCII value: <code>\'H\'</code> (72) + 3 = 75 = <code>\'K\'</code>. Decryption subtracts 3. Use <code>(char)(ch + 3)</code> to encrypt and <code>(char)(encrypted - 3)</code> to decrypt. The <code>(char)</code> cast converts the integer result back to a character.' }
]
</script>
