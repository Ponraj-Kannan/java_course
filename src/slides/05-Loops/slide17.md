...
<div class="flex-col">
  ...
  <div v-after style="background:#f6f8fa;border-radius:10px;border:1px solid #e1e4e8;padding:14px;font-family:'Fira Code',monospace;font-size:.72rem;line-height:1.9;">
    <span style="color:#ef5050;">for</span> (<span style="color:#0e6ead;">int</span> i = <span style="color:#b45309;">1</span>; i &lt;= <span style="color:#b45309;">10</span>; i++) {<br>
    <span style="padding-left:20px;display:block;"><span style="color:#ef5050;">if</span> (i == <span style="color:#b45309;">5</span>) {</span>
    <span style="padding-left:40px;display:block;"><span style="color:#ef5050;">break</span>; <span style="color:#6b7280;">// exit loop at 5</span></span>
  ...
  <div v-click style="margin-top:8px;">
    <div class="section-label" style="margin-bottom:4px;">break Execution Flow</div>
    <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
      <div class="flow-node flow-start" style="width:120px;">for (int i=1...)</div>
      ...
      <div style="display:flex;gap:20px;">
        ...
        <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
          ...
          <div class="flow-arrow">&#x25BC;</div>
          <div class="flow-node flow-body" style="width:90px;font-size:.65rem;">println(i)</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="flex-col">
  ...
  <div v-after style="background:#f6f8fa;border-radius:10px;border:1px solid #e1e4e8;padding:14px;font-family:'Fira Code',monospace;font-size:.72rem;line-height:1.9;">
    <span style="color:#ef5050;">for</span> (<span style="color:#0e6ead;">int</span> i = <span style="color:#b45309;">1</span>; i &lt;= <span style="color:#b45309;">7</span>; i++) {<br>
    <span style="padding-left:20px;display:block;"><span style="color:#ef5050;">if</span> (i % <span style="color:#b45309;">2</span> == <span style="color:#b45309;">0</span>) {</span>
    <span style="padding-left:40px;display:block;"><span style="color:#ef5050;">continue</span>; <span style="color:#6b7280;">// skip even numbers</span></span>
    <span style="padding-left:20px;display:block;">}</span>
    <span style="padding-left:20px;display:block;">System.out.<span style="color:#2d7a00;">println</span>(i);</span>
    }
  </div>
  ...
  <div v-click class="output-box" style="font-size:.72rem;">
    1 &nbsp; 3 &nbsp; 5 &nbsp; 7 &nbsp; <span style="color:#6b7280;">(evens skipped)</span>
  </div>

  <div v-click style="margin-top:8px;">
    <div class="section-label" style="margin-bottom:4px;">continue Execution Flow</div>
    <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
      <div class="flow-node flow-start" style="width:120px;">for (int i=1...)</div>
      <div class="flow-arrow">&#x25BC;</div>
      ...
      <div style="display:flex;gap:20px;">
        <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
          <div style="font-size:.6rem;color:var(--red);font-weight:700;">YES</div>
          <div class="flow-arrow">&#x25BC;</div>
          <div class="flow-node" style="background:#fffaf0;border:1px solid var(--orange);color:var(--orange);width:90px;font-size:.65rem;">Skip → i++</div>
        </div>
        <div style="display:flex;flex-direction:column;align-items:center;gap:3px;">
          <div style="font-size:.6rem;color:var(--green);font-weight:700;">NO</div>
          <div class="flow-arrow">&#x25BC;</div>
